    ...
    implements Context 
{
    ...
    protected Instance(Engine engine,
                       Workflow workflow,
                       String id)
    {
        this.engine   = engine;
    ...
    synchronized Path[] getActiveChildren(Path path)
    {
    ...
    synchronized void push(Path path)
    {
    ...
    synchronized void push(Path[] paths)
    {
    ...
    synchronized void pop(Path path)
    {
    ...
    synchronized void setComplete(boolean complete)
    {
        this.complete = complete;
        notifyAll();
    }

    synchronized Scope getScope(Path path)
    {
