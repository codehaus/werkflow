    ...
    extends WerkflowTestBase
{
        ...
        throws Exception
    {
        ...
        assertSame( "path 0 is workflow itself",
                    workflow,
                    workflow.getComponent( new Path() ) );

        assertSame( "path 00 is body",
                    body,
                    workflow.getComponent( new Path().childPath( 0 ) ) );

        assertSame( "path 00 is subBody",
                    subBody,
                    workflow.getComponent( new Path().childPath( 0 ).childPath( 0 ) ) );
    }
        ...
        throws Exception
    {
        ...
        Path bodyPath    = selfPath.childPath( 0 );
